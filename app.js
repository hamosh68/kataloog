            ...
            <div class="modal-content" style="max-width: 500px;">
                <div style="padding: 20px;">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        <button onclick="exportCartToPDF()" style="flex: 1; padding: 12px; background: #2196F3; color: white; border: none; border-radius: 8px; font-family: 'Cairo'; font-weight: bold; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px;">
